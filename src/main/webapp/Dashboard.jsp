...
<%
    // --- 1. SET UP FILE PATH ---
    // application.getRealPath("/") locates the webapp folder. 
    // We point to members.txt in the root project folder.
...
<head>
    ...
    <style>
        ...
        .program-card { background: #1a1a1a; padding: 20px; border-radius: 8px; }
    </style>
</head>
<body>
